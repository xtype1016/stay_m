...
$config['sess_save_path'] = 'D:\WWW\application\tmp';
...
//sess_regenerate_destroy
//Whether to destroy session data associated with the old session ID when auto-regenerating the session ID. 
//When set to FALSE, the data will be later deleted by the garbage collector.
$config['sess_regenerate_destroy'] = FALSE;
