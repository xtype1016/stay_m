...
/*
    캘린더 컨트롤러
*/
class Calndr extends CI_Controller
{
    public function __construct()
    {
        ...
        {
            info_log("Calndr", "autologin start!");
            auto_login();
        }
    ...
    {
        //$this->list();
        redirect('Calndr/Calndr','refresh');
    }
...
//    public function Calndr()
//    {
//        //$this->output->enable_profiler(TRUE);
//        $this->load->library('pagination');
//
//        info_log("Calndr/list", "================================================================================");
//        info_log("Calndr/list", "체크인 고객 리스트 조회 시작!");
//
//        // 검색 변수 초기화
...
//        $page_url = '';
//
//        //info_log("Calndr/list", "stnd_dt  = [" . $stnd_dt . "]");
//
//        // 페이지네이션 설정
//        $config['base_url']         = '/Calndr/list/' . $page_url . '/page/';
//        $config['total_rows']       = $this->stay_m->get_Calndr_list($stnd_dt, 'rowcnt');         // 표시할 게시물 총 수
...
//        {
//            $data['Calndr_list'] = $this->stay_m->get_Calndr_list($stnd_dt, 'data', $start, $limit);
...
//
//        //info_log("Calndr/list/get_Calndr_list", "data['stnd_dt']  = [" . $data['stnd_dt'] . "]");
//
//        info_log("Calndr/list", "체크인 고객 리스트 조회 완료!");
//        info_log("Calndr/list", "================================================================================");
//
//        $this->load->view('Calndr_list_v', $data);
//    }
