...
<div class="container">
            ...
            <?php echo form_open('', 'method="post" class="form-inline" id="srch_form"'); ?>
                <div class="form-group form-group-sm row">
                    ...
                    <select class="form-control" id="view_cls" name="view_cls">
                        ...
                        <option value="2" selected>매체</option>
    ...
    <table cellspacing="0" cellpadding="0" class="table table-striped table-condensed">
        <thead>
            <tr>
                <th colspan="2" style="text-align: center"><h5>매체</h5></th>
        ...
        <tbody>
            <?php
                if (isset($expns_chnl_smmry))
                {
                    foreach ($expns_chnl_smmry as $e_list)
                    {
            ?>


            <tr>
                <?php if (strlen($e_list->db_no) == 0 && strlen($e_list->expns_chnl_cls) == 0) { ?>
                <td align="center"><h6><?php echo "총 합 계"; ?></h6></td>
                <td align="center"><h6></h6></td>
                <td align="right"><h6><?php echo number_format($e_list->amt);?></h6></td>
                <?php } else if (strncmp($e_list->db_no, "0000000000", 10) == 0 && strncmp($e_list->expns_chnl_cls, "01", 2) == 0) { ?>
                <td align="center"><h6><?php echo $e_list->expns_chnl_cls_nm;?></h6></td>
                <td align="center"><h6></h6></td>
                <td align="right"><a href="/expns/dtl/2/<?php echo $e_list->key_val; ?>"><h6><?php echo number_format($e_list->amt);?></h6></a></td>
                <?php } else if (strncmp($e_list->db_no, "0000000000", 10) != 0 && strlen($e_list->expns_chnl_cls) == 0) { ?>
                <td align="center"><h6><?php echo "카드 합계"; ?></h6></td>
                <td align="center"><h6></h6></td>
                <td align="right"><h6><?php echo number_format($e_list->amt);?></h6></td>
                <?php } else { ?>
                <td align="center"><h6></h6></td>
        ...
        <tfoot>
            <tr>
                ...
                <th style="vertical-align: middle; text-align: right">
                    <a href="/expns/ins/2" class="btn btn-primary btn-sm">입력</a>
                </th>
            </tr>
        </tfoot>
    </table>
