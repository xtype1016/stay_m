    <footer id="footer">
        <nav class="navbar navbar-fixed-bottom">
            <div class="container">
                ...
                <?php if (isset($_SESSION['usr_no']) && strcmp($_SESSION['usr_no'], "0000000006") != 0) { ?>
                ...
                <div class="btn-group btn-group-sm dropup navbar-right" role="group">
                    ...
                    <ul class="dropdown-menu scrollable-menu" role="menu">
                        <?php if (isset($_SESSION['usr_no']) && strcmp($_SESSION['usr_no'], "0000000006") != 0 
                              && strcmp($_SESSION['usr_no'], "0000000007") != 0) { ?>
                            ...
                            <?php } ?>
                            <?php } ?>
                        <?php if (strcmp($_SESSION['db_no'], "0000000002") == 0 || strcmp($_SESSION['usr_no'], "0000000007") == 0 ) { ?>
                            <li class="divider"></li>
                        ...
                        <?php } ?>
                        <li class="divider"></li>
                        <li><a href="/join/upd">비밀번호 변경</a></li>
                        <?php if (strcmp($_SESSION['usr_no'], "0000000007") != 0) { ?>
